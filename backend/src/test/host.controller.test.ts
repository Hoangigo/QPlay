...
describe('Host Routes', () => {
    ...
    describe('POST /host', () => {
        ...
        it('should change a host password', async () => {
            const preRes = await request(API_URL).post('/host/login').send({
                email: TestHost.email,
                password: TestHost.password
            });
        ...
        it('should reset a host password', async () => {
            ...
            const resetRequestRes = await request(API_URL)
            ...
            //get host by email
            const getHostByEmailRes = await request(API_URL)
            ...
            const confirmResetRes = await request(API_URL)
            ...
            //reset password
            const resetRes = await request(API_URL)
